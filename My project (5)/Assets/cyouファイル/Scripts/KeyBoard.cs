...
public class KeyBoard : MonoBehaviour
{
    ...
    public void KeyBoardMove(InputAction.CallbackContext value)
    {
        var vector2 = value.ReadValue<Vector2>();
        moveAmount = new Vector3(vector2.x, 0, vector2.y);
        Debug.Log("Move");
    }
    public void KeyBoardRun(InputAction.CallbackContext button)
    {
        isRun = button.ReadValueAsButton();
    ...
    public void KeyBoardJump(InputAction.CallbackContext button)
    {
        if (isground && button.started)
        {
            pAnimator.SetTrigger("JumpTrigger");
